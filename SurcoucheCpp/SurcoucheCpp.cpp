...
int main()
{
    ...
    // Console::WriteLine(string::Format("Owner: {0}, Function Name: {1}"), _methodInfo.Owner()->ToString(), _methodInfo.Name());
    // const int _count = _methodInfo.Parameters().Count();
    // for (int i = 0; i < _count; ++i)
    // {
    //     const Reflection::ParameterInfo _info = _methodInfo.Parameters()[i];
    //     const string _str = string::Format("Type: {0}, Position: {1}", _info.ParameterType()->ClassName(), _info.Position());
